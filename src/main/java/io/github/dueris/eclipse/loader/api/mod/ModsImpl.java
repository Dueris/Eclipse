...
public final class ModsImpl implements Mods {
	...
	public @Nullable ModContainerImpl getContainerFromResource(ModResource resource) {
		if (resource.locator().equalsIgnoreCase(ModResourceLocator.GAME_LOCATOR) || resource.locator().equalsIgnoreCase(ModResourceLocator.LAUNCHER_LOCATOR))
			return null;
