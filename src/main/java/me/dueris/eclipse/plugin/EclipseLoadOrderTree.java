...
public class EclipseLoadOrderTree {
	...
	public EclipseLoadOrderTree(Map<String, PluginProvider<?>> providerMapMirror, MutableGraph<String> graph) {
		this.providerMap = providerMapMirror;
		this.graph = graph;
	}

	public void add(@NotNull PluginProvider<?> provider) {
	...
	private void logCycleError(@NotNull List<List<String>> cycles, Map<String, PluginProvider<?>> providerMapMirror) {
		LOGGER.error("=================================");
	...
	private void logPluginInfo(@NotNull PluginMeta meta) {
