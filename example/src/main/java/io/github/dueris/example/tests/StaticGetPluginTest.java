...
public class StaticGetPluginTest implements TestInstance {
    ...
    public void test() throws TestFailedException {
        try {
            ...
            TestInstance.LOGGER.trace("{} - JavaPlugin#getProvidingPlugin(){static} (plugin main) test passed", JavaPlugin.getProvidingPlugin(EclipseExample.class).getName());
            TestInstance.LOGGER.trace("{} - JavaPlugin#getProvidingPlugin(){static} test passed", JavaPlugin.getProvidingPlugin(TestInstance.class).getName());
